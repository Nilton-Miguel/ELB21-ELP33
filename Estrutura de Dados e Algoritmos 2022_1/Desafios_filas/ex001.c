...
int main(void){
    ...
    insere_fila(fila, retira_fila(fila));
    insere_pilha(pilha, retira_pilha(pilha));

    printf("%d; %d; ", retira_fila(fila), retira_pilha(pilha));
    printf("%d; %d; \n", retira_pilha(pilha), retira_fila(fila));
